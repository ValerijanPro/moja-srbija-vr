...
medija za analizu ličnih podataka (*personal informatics*), gde prostorni prikaz,
prirodne interakcije rukama i osećaj razmere omogućavaju uvide koje klasičan
2D prikaz (web-mapa) ne pruža.
...
1. **Automatska akvizicija podataka** — povezivanje sa Strava platformom (OAuth 2.0)
   ...
   fotografije), bez ručne pripreme podataka.
...
3. **Prirodne VR interakcije** — selekcija ruta laserskim pokazivačem i direktnim
   dodirom, manipulacija mapom rukama (pomeranje, zumiranje sa dve ruke),
...
4. **Analitičke funkcije** — automatsko grupisanje sličnih putanja, pregled
   ...
   i preporuke narednih ruta na osnovu lične arhive.
...
Rezultat je potpuno **offline** sadržaj — aplikacija ne zavisi od mrežnih servisa
tokom rada.
...
- **Ambijent:** proceduralno generisan zvuk interakcija, muzička podloga,
  podesivo doba dana (položaj sunca).
...
- Vizuelizovano **109 aktivnosti (~2.400 km, ~[UPISATI] m uspona)** iz lične
  četvorogodišnje arhive (2022–2026), automatski grupisano u **[UPISATI] grupa** putanja.
- Maketa Srbije: mesh od ~[UPISATI] hiljada temena isečen po državnoj granici,
...
- Performanse: stabilnih [UPISATI] fps na Quest 2 uređaju.
